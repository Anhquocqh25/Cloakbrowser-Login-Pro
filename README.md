...
Phiên bản mới nhất: **0.1.6**

Bạn có thể chọn một trong hai bản:

### Bản cài đặt trực tiếp

[Download Installer EXE 0.1.6](https://github.com/Anhquocqh25/Cloakbrowser-Login-Pro/releases/download/v0.1.6/CloakBrowser-Login-Pro-Setup-0.1.6-Windows.exe)

1. Tải file EXE ở link trên.
2. Mở file `CloakBrowser-Login-Pro-Setup-0.1.6-Windows.exe`.
...
[Download Portable ZIP 0.1.6](https://github.com/Anhquocqh25/Cloakbrowser-Login-Pro/releases/download/v0.1.6/CloakBrowser-Login-0.1.6-Windows.zip)
...
- UX Pack 0.1.6 rút gọn thanh bộ lọc, thêm More Filters, Settings Center, Profile Defaults, Proxy Settings, Fingerprint Guard Settings và Data/Backup Settings.
...
- `0.1.6`: thanh bộ lọc gọn hơn, More Filters, Settings Center, Profile Defaults, Proxy Settings, Fingerprint Guard Settings và Data/Backup Settings.
