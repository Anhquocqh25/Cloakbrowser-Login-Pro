...
Phiên bản mới nhất: **0.1.4**

Bạn có thể chọn một trong hai bản:

### Bản cài đặt trực tiếp

[Download Installer EXE 0.1.4](https://github.com/Anhquocqh25/Cloakbrowser-Login-Pro/releases/download/v0.1.4/CloakBrowser-Login-Pro-Setup-0.1.4-Windows.exe)

1. Tải file EXE ở link trên.
2. Mở file `CloakBrowser-Login-Pro-Setup-0.1.4-Windows.exe`.
...
[Download Portable ZIP 0.1.4](https://github.com/Anhquocqh25/Cloakbrowser-Login-Pro/releases/download/v0.1.4/CloakBrowser-Login-0.1.4-Windows.zip)
